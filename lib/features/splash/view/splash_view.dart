...
import 'package:ui_vault/features/splash/controller/future_initializer.dart';
import 'package:ui_vault/shared/riverpod_ext/asynvalue_easy_when.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Center(
          child: Image.asset(
            R.ASSETS_IMAGES_APP_LOGO_SPLASH_PNG,
            height: 350,
          ),
        ),
      ),
